...
import com.fajri.bangkit_2024_bfaa.databinding.ActivityMainAlarmManagerBinding
import java.text.SimpleDateFormat
import java.util.Calendar
import java.util.Locale

class MainAlarmManager : AppCompatActivity(), View.OnClickListener,
    DatePickerFragment.DialogDateListener, TimePickerFragment.DialogTimeListener {
    private lateinit var binding: ActivityMainAlarmManagerBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityMainAlarmManagerBinding.inflate(layoutInflater)
