package com.fajri.bangkit_2024_bfaa.BackgroundTaskScheduler.AlarmManager
...
class AlarmReceiver : BroadcastReceiver() {
    // Ketika waktu yang ditentukan cocok dengan waktu yang berjalan pada sistem, maka metode onReceive pada BroadcastReceiver akan dijalankan.
    ...
    // untuk melihat hasil dari alarm manager yang sudah dibuat sebelumnya
    ...
    fun setRepeatingAlarm(context: Context, type: String, time: String, message: String) {
        ...
        // menjalankan obyek PendingIntent pada setiap waktu yang ditentukan dalam millissecond dengan interval per hari
