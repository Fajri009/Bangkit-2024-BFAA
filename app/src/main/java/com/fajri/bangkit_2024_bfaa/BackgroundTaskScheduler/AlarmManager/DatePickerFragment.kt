...
// untuk membantu kita mengambil waktu (untuk setup tanggal)
class DatePickerFragment : DialogFragment(), DatePickerDialog.OnDateSetListener {
    ...
    // Fungsi onDetach() hanya dipanggil sebelum fragmen tidak lagi dikaitkan dengan activity pemanggil
    ...
    // Kemudian setelah tanggal dipilih maka variable tanggal, bulan dan tahun akan dikirim ke MainActivity menggunakan bantuan interface DialogDateListener
