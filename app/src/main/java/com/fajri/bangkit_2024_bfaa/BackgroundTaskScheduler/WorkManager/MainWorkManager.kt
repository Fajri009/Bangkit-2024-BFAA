package com.fajri.bangkit_2024_bfaa.BackgroundTaskScheduler.WorkManager
...
import com.fajri.bangkit_2024_bfaa.databinding.ActivityMainWorkManagerBinding
import java.util.concurrent.TimeUnit

class MainWorkManager : AppCompatActivity(), View.OnClickListener {
    private lateinit var binding: ActivityMainWorkManagerBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityMainWorkManagerBinding.inflate(layoutInflater)
    ...
    private fun startOneTimeTask() {
        ...
        workManager.getWorkInfoByIdLiveData(oneTimeWorkRequest.id)
            .observe(this@MainWorkManager) { workInfo ->
    ...
    private fun startPeriodicTask() {
        ...
        // untuk menjalankan PeriodicWorkRequest dengan interval 15 menit
