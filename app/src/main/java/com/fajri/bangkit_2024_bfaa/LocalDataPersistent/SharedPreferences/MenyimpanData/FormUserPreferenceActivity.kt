...
import com.fajri.bangkit_2024_bfaa.databinding.ActivityFormUserPreferenceBinding
...
class FormUserPreferenceActivity : AppCompatActivity(), View.OnClickListener {
    ...
    // mengubah data hasil dari intent ke View-nya
    ...
    private fun saveUser(name: String, email: String, age: String, phoneNo: String, isLoveMu: Boolean) {
        val userPreference = UserPreference(this@FormUserPreferenceActivity)
