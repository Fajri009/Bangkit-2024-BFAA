...
import com.fajri.bangkit_2024_bfaa.LocalDataPersistent.Room.helper.DateHelper
import com.fajri.bangkit_2024_bfaa.LocalDataPersistent.Room.helper.ViewModelFactory
import com.fajri.bangkit_2024_bfaa.R
import com.fajri.bangkit_2024_bfaa.databinding.ActivityNoteAddUpdate2Binding
...
class NoteAddUpdateActivity : AppCompatActivity() {
    ...
    private var _activityNoteAddUpdate2Binding: ActivityNoteAddUpdate2Binding? = null
    private val binding get() = _activityNoteAddUpdate2Binding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        _activityNoteAddUpdate2Binding = ActivityNoteAddUpdate2Binding.inflate(layoutInflater)
    ...
    override fun onDestroy() {
        super.onDestroy()
        _activityNoteAddUpdate2Binding = null
    }
}
