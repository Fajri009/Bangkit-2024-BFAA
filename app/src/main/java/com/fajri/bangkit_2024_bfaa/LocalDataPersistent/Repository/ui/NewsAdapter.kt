...
import com.fajri.bangkit_2024_bfaa.LocalDataPersistent.Repository.utils.DateFormatter
import com.fajri.bangkit_2024_bfaa.R
import com.fajri.bangkit_2024_bfaa.databinding.ItemNewsBinding
...
class NewsAdapter(private val onBookmarkClick: (NewsEntity) -> Unit): ListAdapter<NewsEntity, NewsAdapter.MyViewHolder>(DIFF_CALLBACK) {
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        // untuk menampilkan state bookmark dan aksi ketika bookmark ditekan
        // Alasan mengapa kode ini dimasukkan di onBindViewHolder, bukan di ViewHolder, karena kita ingin menyimpan state dari bookmark yang ditandai
        // Apabila Anda meletakkan kode ini di ViewHolder, maka state akan ikut ter-recycle (daur ulang) yang menyebabkan tanda tidak semestinya.
        ...
        // untuk melakukan aksi ketika ikon bookmark ditekan
